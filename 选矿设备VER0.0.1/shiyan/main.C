...
*修改内容:增加测量铁粉数量的程序，再ADC测试的窗口可以查询目前的电压值 
*日期：2014年2月20日 
* 
...
char * VERSION = "Ver 0.0.2";			//开机时显示的版本号
/*
*********************************************************************************************************
*                                              CONSTANTS
*********************************************************************************************************
...
//    /*task 1*/
 ...
 //建立读取DO任务
	...
	OSTaskCreateExt(Task_Switch3,
				  (void *)0,
				  &TASK_SWITCH3_STK[256 - 1],
				  TASK_SWITCH3_PRIO,
				  TASK_SWITCH3_ID,
				  &TASK_SWITCH3_STK[0],
				  256,
	...
	OSTaskCreateExt(Task_Switch4,
				  (void *)0,
				  &TASK_SWITCH4_STK[256 - 1],
				  TASK_SWITCH4_PRIO,
				  TASK_SWITCH4_ID,
				  &TASK_SWITCH4_STK[0],
				  256,
	...
	OSTaskCreateExt(Task_Switch5,
				  (void *)0,
				  &TASK_SWITCH5_STK[256 - 1],
				  TASK_SWITCH5_PRIO,
				  TASK_SWITCH5_ID,
				  &TASK_SWITCH5_STK[0],
				  256,
	...
	OSTaskCreateExt(Task_Switch6,
				  (void *)0,
				  &TASK_SWITCH6_STK[256 - 1],
				  TASK_SWITCH6_PRIO,
				  TASK_SWITCH6_ID,
				  &TASK_SWITCH6_STK[0],
				  256,
	...
	OSTaskCreateExt(Task_Switch7,
				  (void *)0,
				  &TASK_SWITCH7_STK[256 - 1],
				  TASK_SWITCH7_PRIO,
				  TASK_SWITCH7_ID,
				  &TASK_SWITCH7_STK[0],
				  256,
