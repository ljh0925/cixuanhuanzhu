...
struct MENU mu[MENU_MAX_ITEM] = 
{
	...
	{ "4.修改密码",     0,  &mu[4],     &mu[2],     NULL,       NULL,       NULL,           0,      NULL,    			NULL,},	//3
...
INT8U LcdDispInputPasswd(void *pass)
{
	...
	Lcd_Cls();
// 	LCD_Display_Str(1, 2, "请输入密码: ", NORMAL);
	lcddisp(1, 1, "请输入密码: ");
// 	LCD_Display_Str(2, 2, " ", REVERSE);
// 	LCD_Display_Str(2, 2, "_", NORMAL);
...
// 		LCD_Display_Str(2, 0, buf, NORMAL);
	...
	{
// 		LCD_Display_Str(3, 2, "密码错误!", NORMAL);
		lcddisp(3, 1, "密码错误!");
		BeepInputErr();
